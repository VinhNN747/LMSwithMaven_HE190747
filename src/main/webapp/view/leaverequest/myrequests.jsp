                    ...
                    <div class="card-body">
                        <form method="get" class="row g-2 mb-3">
                            ...
                            <div class="col">
                                ...
                                <a href="myrequests" class="btn btn-secondary ms-2">Reset</a>
                            </div>
                        </form>
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <c:if test="${totalPages > 1}">
                                    <nav aria-label="MyRequests pagination">
                                        <form method="get" action="myrequests" class="myrequests-pagination-form d-flex justify-content-center align-items-center mt-3" style="gap: 0.5rem;">
