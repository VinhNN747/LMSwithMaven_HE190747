...
public abstract class BaseUserServlet extends HttpServlet {
     ...
     * Only allows transitions between adjacent levels (e.g., Employee -> Lead,
     * Lead -> Head)
     */
    ...
    /**
     * Maps roles to their hierarchical levels: Employee = 1 (base level) Lead =
     * 2 (middle level) Head = 3 (top level)
     */
